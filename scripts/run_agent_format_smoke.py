...
TWENTY_TURN_CONVERSATION = [
    ...
    "What audit note should a human reviewer save?",
    ...
    "Which cancellation risk should we review first?",
    "Preview the safest admin action for this context.",
    "Generate QA tests for Refund Ops and Content Radar.",
    "What Gumroad help doc source should we cite for chargebacks?",
    "What is still review-only and must not execute?",
